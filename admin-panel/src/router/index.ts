...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'questions/new', name: 'QuestionNew', component: () => import('../pages/questions/QuestionForm.vue') },
      { path: 'questions/:id/edit', name: 'QuestionEdit', component: () => import('../pages/questions/QuestionForm.vue') },
