...
<div class="result-hero-wrapper space-y-6 sm:space-y-8">
        ...
        <div class="relative z-10 space-y-4">
            ...
            <div class="hero-score-ring">
                ...
                <div class="score-inner-disc">
                    ...
                    <span class="text-[10px] font-black uppercase tracking-widest text-white/70 mt-1">Score</span>
                </div>
            ...
            <div class="space-y-1.5">
                ...
                <h2 class="text-2xl sm:text-4xl font-black italic uppercase tracking-tight text-white leading-tight">
                    @if($result['score'] >= 90) Magnificent! 🌟 @elseif($result['score'] >= 75) Well Done! 🚀 @elseif($result['score'] >= 60) Good Effort! 👍 @else Keep Learning! 🎯 @endif
                </h2>
    ...
    <section class="bg-gradient-to-r from-amber-500/10 via-amber-400/20 to-amber-500/10 border-2 border-amber-400/30 rounded-2xl p-4 flex items-center justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h4 class="font-black text-xs sm:text-sm uppercase tracking-wide text-amber-900">Star XP Earned!</h4>
                <p class="text-3xs sm:text-2xs font-bold text-amber-700">Completed quiz session saved to your profile</p>
            </div>
        </div>
    ...
    <section class="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div class="stat-card-item">
            <span class="material-symbols-outlined !text-xl text-[rgb(var(--primary))] mb-1">pie_chart</span>
            <div class="text-lg sm:text-2xl font-black text-[rgb(var(--on-surface))]">{{ $result['score'] }}%</div>
            <div class="text-3xs font-black uppercase tracking-widest text-[rgb(var(--on-surface))/0.5]">Accuracy</div>
        </div>
        <div class="stat-card-item">
        ...
        <div class="space-y-3">
            ...
            <div class="breakdown-card {{ $answer['is_correct'] ? 'pass' : ($answer['is_correct'] === false ? 'fail' : '') }} review-card-item" data-status="{{ $statusType }}">
                ...
                <div class="flex items-center justify-between gap-3 mb-2.5">
                    <span class="text-3xs font-black uppercase tracking-widest text-[rgb(var(--primary))] bg-[rgb(var(--primary))/0.1] px-2.5 py-0.5 rounded-full">
                        Question {{ $i + 1 }}
                    </span>
                    <div>
    ...
    <section class="pt-2">
        <div class="flex items-center gap-3 sm:gap-4">
            <a href="{{ route('quiz', $quiz->id) }}" class="flex-1 py-3.5 sm:py-4 bg-[rgb(var(--primary))] text-white hover:opacity-95 rounded-full font-black text-xs sm:text-sm active:scale-95 transition-all flex items-center justify-center gap-2 uppercase tracking-widest shadow-xl shadow-[rgb(var(--primary))/0.25] no-underline">
                <span class="material-symbols-outlined !text-xl">replay</span>
                Retake Quiz
            </a>
            <a href="{{ route('topics') }}" class="flex-1 py-3.5 sm:py-4 bg-[rgb(var(--surface-container-high))] text-[rgb(var(--on-surface))] hover:bg-[rgb(var(--surface-container-high))/0.8] rounded-full font-black text-xs sm:text-sm active:scale-95 transition-all flex items-center justify-center gap-2 uppercase tracking-widest no-underline">
